...
namespace BlazorApp.Controllers
{
    public class DatabaseController
    {
        ...
        public DatabaseController(IConfiguration configuration)
        {
            ...
            _database = client.GetDatabase("weather_forecast");
        ...
        {
            var favoriteCities = _database.GetCollection<Favourite>("FavoriteCities"); // Ensure this is initialized
            return await favoriteCities.Find(_ => true).ToListAsync();
        }
