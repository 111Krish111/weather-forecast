...
namespace BlazorApp.Services
{
    public class PersonalInfoService
    {
        ...
        {
            var client = new MongoClient("mongodb+srv://krishpareek58:Krishpareek%400@krishna.96axx.mongodb.net/"); // MongoDB connection string
            var database = client.GetDatabase("weather_forecast"); // Database name
